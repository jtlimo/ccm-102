...
Segundo Isleyen e Bahtiyar (2024, tradução nossa) \enquote{Os algoritmos de aprendizado de máquina podem analisar]
grandes volumes de dados para identificar padrões e anomalias sutis
que são indicativas de falsificação.}
